...
## Description:
## Cette partie traite le problème de la simulation du processus
## par lequel une espèce végétale colonise une nouvelle zone.
## Si la modélisation se fait au niveau des plantes individuelles,
## alors il est possible de simuler où les graines de chaque plante
## atterrissent. C'est-à-dire, il est possible de simuler la distance
## radiale R.
## Ce code permet de simuler la densité radiale fr en utilisant une
## densité du transect ft donnée.
